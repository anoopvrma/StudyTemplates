                        ...
                        <Grid item xs={12}>
                            <Box sx={{ display: 'flex', justifyContent: 'center' }}>
                                <Typography variant='h3' fontWeight='bold' textAlign={'center'} color={theme.palette.grey[800]} >
                                    Our <Box color={theme.palette.secondary.main} component="span">Foundation</Box>
                                </Typography>
                            </Box>
                        </Grid>
                        <Grid item xs={12}>
                ...
                <Container>
                    ...
                    >
                        <Grid item xs={12}>
                            <Box sx={{ display: 'flex', justifyContent: 'center' }}>
                                <Typography variant='h3' fontWeight='bold' textAlign={'center'} color={theme.palette.grey[800]} >
                                    Message from our <Box color={theme.palette.secondary.main} component="span">Leadership</Box>
                                </Typography>
                            </Box>
                        </Grid>
                        <Grid item xs={12}>
