  ...
  return (
    <>
      <Grid>
        ...
        <Grid item xs={12} sx={{ background: theme.palette.grey[200] }} py={6}>
          <Container>
            <Grid
              container
              direction="row"
              ...
              <Grid item xs={12}>
                <Box sx={{ display: 'flex', justifyContent: 'center' }}>
                  <Typography variant='h3' fontWeight='bold' textAlign={'center'} color={theme.palette.grey[800]} >
                    Welcome to <Box color={theme.palette.secondary.main} component="span"> The {basicInfo.name}</Box>
                  </Typography>
                </Box>
              </Grid>
              <Grid item xs={12}>
        ...
        <Grid item xs={12} sx={{ background: theme.palette.background.paper, color: theme.palette.grey[800], pb: 4 }}>
          <Subscribe theme={theme} />
        </Grid>
        <Grid item xs={12} sx={{ background: theme.palette.grey[100], color: theme.palette.grey[800], py: 4 }}>
          <Contact />
        </Grid>
      </Grid>

      <Grid item xs={12} sx={{ background: theme.palette.secondary.light }} py={6}>
        <Container>
          <Grid
            container
            direction="row"
