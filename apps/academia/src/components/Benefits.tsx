...
function Benefits() {
    ...
    const detailsColor = theme.palette.text.secondary;
    ...
    return (
        <>
            ...
            <Box pt={6}>
                <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')} disableGutters sx={{ my: 1 }} elevation={0}>
                    <AccordionSummary
                ...
                <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')} disableGutters sx={{ my: 1 }} elevation={0} >
                    <AccordionSummary
                        expandIcon={<ExpandMoreIcon sx={{ color: summaryColor }} />}
                ...
                <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')} disableGutters sx={{ my: 1 }} elevation={0}>
                    <AccordionSummary
                        expandIcon={<ExpandMoreIcon sx={{ color: summaryColor }} />}
                ...
                <Accordion expanded={expanded === 'panel4'} onChange={handleChange('panel4')} disableGutters sx={{ my: 1 }} elevation={0}>
                    <AccordionSummary
                        expandIcon={<ExpandMoreIcon sx={{ color: summaryColor }} />}
